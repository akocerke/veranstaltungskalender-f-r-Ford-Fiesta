        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="mx-auto">
              ...
              {userRole === 'admin' && (
                <Nav.Link className="me-3" as={Link} to="/admin/dashboard" onClick={() => setIsNavExpanded(false)}>
                  <i className="bi bi-gear p-1"></i>Admin Dashboard
                </Nav.Link>
              )}
              {userRole === 'user' && (
                <Nav.Link className="me-3" as={Link} to="/users/dashboard" onClick={() => setIsNavExpanded(false)}>
