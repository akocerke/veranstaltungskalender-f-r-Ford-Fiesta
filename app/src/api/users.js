...
export const getUserDashboard = async () => {
  try {
    ...
    const { events, ratings, comments, violations } = response.data
...
export const getUserProfile = async () => {
  try {
    ...
    console.error(
      'Fehler beim Abrufen der Profil-Daten:',
      error.response ? error.response.data : error.message
    )
    throw error
  }
...
export const updateUserProfile = async (updatedData) => {
  try {
    ...
    console.error(
      'Fehler beim Aktualisieren der Profil-Daten:',
      error.response ? error.response.data : error.message
    )
    throw error
  }
  ...
  try {
    ...
    return {
      ...
      message:
        ...
        'Error: Unable to create event or upload image.', // Hier wird die API-Fehlermeldung verwendet
    }
  }
}
...
export const updateEvent = async (eventDetails, imageFile) => {
  ...
  try {
    ...
    return {
      ...
      message:
        error.response?.data?.message ||
        'Error: Unable to update event or upload image.',
    }
  }
}
