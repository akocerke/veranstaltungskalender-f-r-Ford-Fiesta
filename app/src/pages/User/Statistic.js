      ...
      <Row className="g-4 mt-3">
        ...
        <Col md={4}>
          <Card className="text-center shadow-lg">
            <Card.Body>
              <i className="bi bi-calendar-event-fill" style={{ fontSize: '3rem', color: '#198754' }}></i>
              <Card.Title className="mt-3">Meine Events</Card.Title>
              <Card.Text>
                <h3>
                  <Badge bg="success" className="bg-opacity-50">{stats.eventCount}</Badge>
                </h3>
              </Card.Text>
            </Card.Body>
          </Card>
        ...
        <Col md={4}>
          <Card className="text-center shadow-lg">
            <Card.Body>
              ...
              <Card.Text>
                <h3>
                  <Badge bg="warning" className="bg-opacity-50">{stats.ratingCount}</Badge>
                </h3>
              </Card.Text>
            </Card.Body>
          </Card>
        ...
        <Col md={4}>
          <Card className="text-center shadow-lg">
            <Card.Body>
              <i className="bi bi-chat-left-text-fill" style={{ fontSize: '3rem', color: '#0d6efd' }}></i>
              <Card.Title className="mt-3">Meine Kommentare</Card.Title>
              <Card.Text>
                <h3>
                  <Badge bg="primary" className="bg-opacity-50">{stats.commentCount}</Badge>
                </h3>
              </Card.Text>
            </Card.Body>
          </Card>
        ...
        <Col md={4}>
          <Card className="text-center shadow-lg">
            <Card.Body>
              ...
              <Card.Title className="mt-3">Meine gemeldeten Verstöße</Card.Title>
              <Card.Text>
                <h3>
                  <Badge bg="danger" className="bg-opacity-50">{stats.totalViolations}</Badge>
                </h3>
              </Card.Text>
            </Card.Body>
          </Card>
        ...
        <Col md={4}>
          <Card className="text-center shadow-lg">
            <Card.Body>
              <i className="bi bi-hourglass-split" style={{ fontSize: '3rem', color: '#ffc107' }}></i>
              <Card.Title className="mt-3">Verstöße in Bearbeitung</Card.Title>
              <Card.Text>
                <h3>
                  <Badge bg="warning" className="bg-opacity-50">{stats.pendingViolations}</Badge>
                </h3>
              </Card.Text>
            </Card.Body>
          </Card>
        ...
        <Col md={4}>
          <Card className="text-center shadow-lg">
            <Card.Body>
              ...
              <Card.Text>
                <h3>
                  <Badge bg="success" className="bg-opacity-50">{stats.resolvedViolations}</Badge>
                </h3>
              </Card.Text>
            </Card.Body>
          </Card>
