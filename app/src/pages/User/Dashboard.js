      ...
      <Row>
        ...
        <Col md={3}>
          ...
          <Nav className="flex-column">
            ...
            >
              <i className={`bi bi-graph-up-arrow ${styles.sidebarIcon}`}></i>{' '}
              Meine Statistiken
            </Nav.Link>
            ...
            <Nav.Link as={Link} to="events" className={styles.navLink}>
              <i className={`bi bi-calendar ${styles.sidebarIcon}`}></i> Meine
              Events
            </Nav.Link>
          </Nav>
        </Col>
        ...
        <Col md={9} className="mb-3">
          ...
          {/* Statistiken werden über den Outlet-Kontext übergeben */}
        </Col>
      </Row>
    </Container>
  )
