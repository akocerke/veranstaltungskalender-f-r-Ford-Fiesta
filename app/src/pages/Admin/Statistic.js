...
const Statistic = () => {
  ...
  return (
    <Container className="mt-5 mb-5">
      <h5 className="headline text-success mt-3 mb-3 text-lg-start">Statistik</h5>
        ...
        <Col md={4}>
          <Card className="text-center shadow-lg">
            <Card.Body>
              ...
              <Card.Text>
                <h3>
                  <Badge bg="primary" className="bg-opacity-50">{stats.userCount}</Badge>
                </h3>
              </Card.Text>
            </Card.Body>
          </Card>
        ...
        <Col md={4}>
          <Card className="text-center shadow-lg">
            <Card.Body>
              ...
              <Card.Text>
                <h3>
                  <Badge bg="danger" className="bg-opacity-50">{stats.violationCount}</Badge>
                </h3>
              </Card.Text>
            </Card.Body>
          </Card>
