      ...
      <Row className="justify-content-center">
        <Col md={6}>
          ...
          <p>
            ...
            Datenschutzrichtlinie beschreibt, wie wir Ihre Daten erfassen,
            verwenden und schützen.
          </p>
          <p className="headline2 mt-2">Erfassung und Verwendung von Daten</p>
          <p>
            Wir erfassen verschiedene Arten von Informationen, um unseren
            Service bereitzustellen und zu verbessern:
          </p>
          <ul className="text-start">
            <li>
              <strong>Persönliche Daten</strong> Informationen, die zur
              Identifizierung Ihrer Person verwendet werden können, wie Name,
              E-Mail-Adresse und Telefonnummer.
            </li>
            <li>
              <strong>Nutzungsdaten</strong> Informationen darüber, wie Sie
              unseren Service nutzen, wie z.B. IP-Adresse, Browsertyp und
              Besuchsdauer.
            </li>
          </ul>
          ...
          <p>
            ...
            um Ihre Daten gegen Manipulation, Verlust, Zerstörung oder gegen den
          ...
          <p>
            ...
            Berichtigung, Löschung und Sperrung einzelner personenbezogener
            Daten verlangen.
          </p>
          <p className="headline2 mt-2">
            Änderungen dieser Datenschutzrichtlinie
          </p>
          <p>
            Wir behalten uns das Recht vor, diese Datenschutzrichtlinie
            jederzeit zu ändern. Die jeweils aktuelle Version ist auf unserer
            Webseite verfügbar.
          </p>
